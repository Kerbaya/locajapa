		...
		implements Connection
{
	...
	{
		return new StatementImpl<>(ix.createStatement(wrapped), stmtIx);
	}

	@Override
	public PreparedStatement prepareStatement(String sql) throws SQLException
	{
		return new PreparedStatementImpl<>(ix.prepareStatement(wrapped, sql), psIx);
	}

	@Override
	public CallableStatement prepareCall(String sql) throws SQLException
	{
		return new CallableStatementImpl(ix.prepareCall(wrapped, sql), csIx);
	}
